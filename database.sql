...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."COMPANY" 
   (	"COMPANYID" VARCHAR2(45 BYTE), 
	"COMPANYNAME" VARCHAR2(45 BYTE), 
	"CONTACTPERSON" VARCHAR2(45 BYTE), 
	"TELNO" VARCHAR2(45 BYTE), 
	"FAXNO" VARCHAR2(45 BYTE), 
	"EMAIL" VARCHAR2(45 BYTE), 
	"PASSWORD" VARCHAR2(45 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOCATION" 
   (	"LOCATIONID" NUMBER(*,0), 
	...
	"POSCODE" VARCHAR2(45 BYTE), 
	"CITY" VARCHAR2(45 BYTE), 
	"STATE" VARCHAR2(45 BYTE), 
	"STAFFID" VARCHAR2(45 BYTE), 
	"COMPANYID" VARCHAR2(45 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."OFFER" 
   (	"OFFERID" NUMBER(*,0), 
	"COURSE" VARCHAR2(45 BYTE), 
	"CGPA" FLOAT(10), 
	"NO_OF_PLACEMENT" NUMBER(*,0), 
	"TOTAL_NO_PLACEMENT" NUMBER(*,0), 
	"BENEFITS" VARCHAR2(100 BYTE), 
...
--------------------------------------------------------
--  DDL for Table RESPONSE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."RESPONSE" 
   (	"OFFERID" NUMBER(*,0), 
	"STUDENTID" VARCHAR2(45 BYTE), 
	"OFFERSTATUS" VARCHAR2(45 BYTE), 
	"RESPONSSTATUS" VARCHAR2(45 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."SESION" 
   (	"SESSIONID" VARCHAR2(30 BYTE), 
	"STARTDATE" VARCHAR2(45 BYTE), 
	"ENDDATE" VARCHAR2(45 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."STUDENT" 
   (	"STUDENTID" VARCHAR2(15 BYTE), 
	"NAME" VARCHAR2(45 BYTE), 
	"COURSE" VARCHAR2(4 BYTE), 
	"CGPA" NUMBER(4,0), 
	"TELNO" VARCHAR2(11 BYTE), 
	"IC" VARCHAR2(12 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."SUPERVISOR" 
   (	"STAFFID" VARCHAR2(45 BYTE), 
	"SUPERVISORNAME" VARCHAR2(45 BYTE), 
	"TELNO" VARCHAR2(20 BYTE), 
	"EMAIL" VARCHAR2(50 BYTE), 
	"AREA_IN_CHARGE" VARCHAR2(50 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
SET DEFINE OFF;
Insert into SYSTEM.ADMIN (ADMINID,NAME,EMAIL,PASSWORD) values ('A001','khaled','khaled@gmail.com','1141');
Insert into SYSTEM.ADMIN (ADMINID,NAME,EMAIL,PASSWORD) values ('A002','omar','omar@gmail.com','2241');
Insert into SYSTEM.ADMIN (ADMINID,NAME,EMAIL,PASSWORD) values ('A003','hassan','hassan@gmail.com','3341');
Insert into SYSTEM.ADMIN (ADMINID,NAME,EMAIL,PASSWORD) values ('A004','ali','ali@gmail.com','4441');
Insert into SYSTEM.ADMIN (ADMINID,NAME,EMAIL,PASSWORD) values ('A005','faiz','faiz@gmail.com','5541');
Insert into SYSTEM.ADMIN (ADMINID,NAME,EMAIL,PASSWORD) values ('1','Data to insert     ','Data to insert     ',null);
Insert into SYSTEM.ADMIN (ADMINID,NAME,EMAIL,PASSWORD) values ('Data to insert     ','Data to insert     ','Data to insert     ','Data to insert     ');
REM INSERTING into SYSTEM.ADMIN1
SET DEFINE OFF;
Insert into SYSTEM.ADMIN1 (ADMINID,PASSWORD) values ('B031310504','112233');
Insert into SYSTEM.ADMIN1 (ADMINID,PASSWORD) values ('B031310506','223344');
...
SET DEFINE OFF;
Insert into SYSTEM.COMPANY (COMPANYID,COMPANYNAME,CONTACTPERSON,TELNO,FAXNO,EMAIL,PASSWORD) values ('C013','Aljamel','111777','366547','5574414','jamel@gmail.com','117452');
Insert into SYSTEM.COMPANY (COMPANYID,COMPANYNAME,CONTACTPERSON,TELNO,FAXNO,EMAIL,PASSWORD) values ('”Ù÷ÖðƒA^4ð',null,null,null,null,null,null);
Insert into SYSTEM.COMPANY (COMPANYID,COMPANYNAME,CONTACTPERSON,TELNO,FAXNO,EMAIL,PASSWORD) values ('”á}‹OµÐ3ð',null,null,null,null,null,null);
Insert into SYSTEM.COMPANY (COMPANYID,COMPANYNAME,CONTACTPERSON,TELNO,FAXNO,EMAIL,PASSWORD) values ('C001','ccm1','02522141','22322552','445588','ccm@gmail.com','123');
Insert into SYSTEM.COMPANY (COMPANYID,COMPANYNAME,CONTACTPERSON,TELNO,FAXNO,EMAIL,PASSWORD) values ('C002','ccn2','45252141','225895552','667488','ccn@gmail.com','456');
Insert into SYSTEM.COMPANY (COMPANYID,COMPANYNAME,CONTACTPERSON,TELNO,FAXNO,EMAIL,PASSWORD) values ('C003','AmBank','45252661','225444752','662258','ambank@gmail.com','562');
Insert into SYSTEM.COMPANY (COMPANYID,COMPANYNAME,CONTACTPERSON,TELNO,FAXNO,EMAIL,PASSWORD) values ('C004','Astro Holdings','45274741','225897412','667488','astro@gmail.com','258');
Insert into SYSTEM.COMPANY (COMPANYID,COMPANYNAME,CONTACTPERSON,TELNO,FAXNO,EMAIL,PASSWORD) values ('C005','Axiata','45112541','225895552','667488','ax_4@gmail.com','526');
Insert into SYSTEM.COMPANY (COMPANYID,COMPANYNAME,CONTACTPERSON,TELNO,FAXNO,EMAIL,PASSWORD) values ('C012','aramco','1114125','3665225','552214','ar@gmail.com','114454');
REM INSERTING into SYSTEM.CUSTOMER
SET DEFINE OFF;
Insert into SYSTEM.CUSTOMER (ID,FNAME,LNAME,ADDRESS,POSTCODE) values ('C001','Ahmed','Omar','bukit jalil','P001');
Insert into SYSTEM.CUSTOMER (ID,FNAME,LNAME,ADDRESS,POSTCODE) values ('C002','yasser','khaled','bukit jalil','P002');
Insert into SYSTEM.CUSTOMER (ID,FNAME,LNAME,ADDRESS,POSTCODE) values ('C003','Ridwan','Ahmed','durian tungal','P003');
Insert into SYSTEM.CUSTOMER (ID,FNAME,LNAME,ADDRESS,POSTCODE) values ('C004','Talal','Mahmoud','batu brendam','P004');
Insert into SYSTEM.CUSTOMER (ID,FNAME,LNAME,ADDRESS,POSTCODE) values ('C005','Hassan','Ali','bukit beruang','P005');
...
SET DEFINE OFF;
Insert into SYSTEM.LOCATION (LOCATIONID,ADDRESS,POSCODE,CITY,STATE,STAFFID,COMPANYID) values (1001,'A001','P001','Kuala-lumpur','butrojaya','S001','C001');
Insert into SYSTEM.LOCATION (LOCATIONID,ADDRESS,POSCODE,CITY,STATE,STAFFID,COMPANYID) values (1002,'A002','P002','Melaka','Melaka-state','S002','C002');
Insert into SYSTEM.LOCATION (LOCATIONID,ADDRESS,POSCODE,CITY,STATE,STAFFID,COMPANYID) values (1003,'A003','P003','sabah','butro','S003','C003');
Insert into SYSTEM.LOCATION (LOCATIONID,ADDRESS,POSCODE,CITY,STATE,STAFFID,COMPANYID) values (1004,'A004','P004','subang jaya','subang-state','S004','C004');
Insert into SYSTEM.LOCATION (LOCATIONID,ADDRESS,POSCODE,CITY,STATE,STAFFID,COMPANYID) values (1005,'A005','P005','penang','penang-state','S005','C005');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.MYTAB
SET DEFINE OFF;
Insert into SYSTEM.MYTAB (COL1) values (555);
Insert into SYSTEM.MYTAB (COL1) values (555);
REM INSERTING into SYSTEM.OFFER
SET DEFINE OFF;
Insert into SYSTEM.OFFER (OFFERID,COURSE,CGPA,NO_OF_PLACEMENT,TOTAL_NO_PLACEMENT,BENEFITS,SCOPE,GENDER,LOCATIONID,ALLOWANCE,STATUS) values (1001,'BITD',3.2,2211,20,'Developer','database','Male',1001,4,'accept');
Insert into SYSTEM.OFFER (OFFERID,COURSE,CGPA,NO_OF_PLACEMENT,TOTAL_NO_PLACEMENT,BENEFITS,SCOPE,GENDER,LOCATIONID,ALLOWANCE,STATUS) values (1002,'BITD',3.1,1221,30,'Enginer','database programing','Female',1003,4,'accept');
Insert into SYSTEM.OFFER (OFFERID,COURSE,CGPA,NO_OF_PLACEMENT,TOTAL_NO_PLACEMENT,BENEFITS,SCOPE,GENDER,LOCATIONID,ALLOWANCE,STATUS) values (1003,'BITI',3.2,2231,40,'Developer','database','Male',1004,3,'accept');
Insert into SYSTEM.OFFER (OFFERID,COURSE,CGPA,NO_OF_PLACEMENT,TOTAL_NO_PLACEMENT,BENEFITS,SCOPE,GENDER,LOCATIONID,ALLOWANCE,STATUS) values (1004,'BITZ',3.1,1241,10,'Enginer','database programing','Female',1005,3,'reject');
Insert into SYSTEM.OFFER (OFFERID,COURSE,CGPA,NO_OF_PLACEMENT,TOTAL_NO_PLACEMENT,BENEFITS,SCOPE,GENDER,LOCATIONID,ALLOWANCE,STATUS) values (1005,'BITS',3.2,2251,5,'Developer','database','Male',1002,3,'accept');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.RESPONSE
SET DEFINE OFF;
Insert into SYSTEM.RESPONSE (OFFERID,STUDENTID,OFFERSTATUS,RESPONSSTATUS) values (1001,'B031310504','1','Accept');
Insert into SYSTEM.RESPONSE (OFFERID,STUDENTID,OFFERSTATUS,RESPONSSTATUS) values (1002,'B031312142','2','Accept');
Insert into SYSTEM.RESPONSE (OFFERID,STUDENTID,OFFERSTATUS,RESPONSSTATUS) values (1003,'B031312774','3','Accept');
Insert into SYSTEM.RESPONSE (OFFERID,STUDENTID,OFFERSTATUS,RESPONSSTATUS) values (1004,'B031312552','4','Accept');
Insert into SYSTEM.RESPONSE (OFFERID,STUDENTID,OFFERSTATUS,RESPONSSTATUS) values (1005,'B031963142','5','Accept');
REM INSERTING into SYSTEM.SESION
SET DEFINE OFF;
Insert into SYSTEM.SESION (SESSIONID,STARTDATE,ENDDATE,STATUS,ADMINID) values ('S001','2/12/2015','2/1/2016','Accept','A001');
Insert into SYSTEM.SESION (SESSIONID,STARTDATE,ENDDATE,STATUS,ADMINID) values ('S002','2/9/2015','2/3/2016','Accept','A002');
Insert into SYSTEM.SESION (SESSIONID,STARTDATE,ENDDATE,STATUS,ADMINID) values ('S003','2/12/2015','2/1/2016','Accept','A003');
Insert into SYSTEM.SESION (SESSIONID,STARTDATE,ENDDATE,STATUS,ADMINID) values ('S004','2/9/2015','9/3/2016','Accept','A004');
Insert into SYSTEM.SESION (SESSIONID,STARTDATE,ENDDATE,STATUS,ADMINID) values ('S005','2/12/2015','17/5/2016','Reject','A005');
Insert into SYSTEM.SESION (SESSIONID,STARTDATE,ENDDATE,STATUS,ADMINID) values ('S025','22/08/2016','22/08/2017','Accept','A003');
Insert into SYSTEM.SESION (SESSIONID,STARTDATE,ENDDATE,STATUS,ADMINID) values ('1-2015/2016','2015-11-10','2015-12-09','EXPIRED','A003');
Insert into SYSTEM.SESION (SESSIONID,STARTDATE,ENDDATE,STATUS,ADMINID) values ('2-2015/2016','2015-12-12','2015-12-13','EXPIRED','A003');
REM INSERTING into SYSTEM.SQLPLUS_PRODUCT_PROFILE
SET DEFINE OFF;
REM INSERTING into SYSTEM.STUDENT
SET DEFINE OFF;
Insert into SYSTEM.STUDENT (STUDENTID,NAME,COURSE,CGPA,TELNO,IC,GENDER,EMAIL,PASSWORD) values ('B031310504','Ahmed','BITD',3,'0163095052','P00235798','Male','ashiekh295@gmail.com','112233');
Insert into SYSTEM.STUDENT (STUDENTID,NAME,COURSE,CGPA,TELNO,IC,GENDER,EMAIL,PASSWORD) values ('B031312142','Amira','BITD',4,'0163054482','C00233598','Female','mira@gmail.com','113385');
Insert into SYSTEM.STUDENT (STUDENTID,NAME,COURSE,CGPA,TELNO,IC,GENDER,EMAIL,PASSWORD) values ('B031312552','omar','BITC',3,'0163054482','C00255598','Male','omar@gmail.com','116533');
Insert into SYSTEM.STUDENT (STUDENTID,NAME,COURSE,CGPA,TELNO,IC,GENDER,EMAIL,PASSWORD) values ('B031312774','yasser','BITS',3,'0168854482','C00773598','Male','yasser@gmail.com','115563');
Insert into SYSTEM.STUDENT (STUDENTID,NAME,COURSE,CGPA,TELNO,IC,GENDER,EMAIL,PASSWORD) values ('B031963142','Aisya','BITD',3,'0178964482','C00333598','Female','Aisya@gmail.com','117445');
REM INSERTING into SYSTEM.SUPERVISOR
SET DEFINE OFF;
Insert into SYSTEM.SUPERVISOR (STAFFID,SUPERVISORNAME,TELNO,EMAIL,AREA_IN_CHARGE) values ('S001','Syahida','22322544','syahida@utem.edu.my','Kuala-lumpur');
Insert into SYSTEM.SUPERVISOR (STAFFID,SUPERVISORNAME,TELNO,EMAIL,AREA_IN_CHARGE) values ('S002','Azlinor','0163251455','azlinor@utem.edu.my','Penang');
Insert into SYSTEM.SUPERVISOR (STAFFID,SUPERVISORNAME,TELNO,EMAIL,AREA_IN_CHARGE) values ('S003','Masilita abdulaziz','288927412','Masilita@utem.edu.my','Melaka');
Insert into SYSTEM.SUPERVISOR (STAFFID,SUPERVISORNAME,TELNO,EMAIL,AREA_IN_CHARGE) values ('S004','En.razaq','2278525552','razaq@utem.edu.my','Melaka');
Insert into SYSTEM.SUPERVISOR (STAFFID,SUPERVISORNAME,TELNO,EMAIL,AREA_IN_CHARGE) values ('S005','En.yahya Ibrahim','225844552','yahya@utem.edu.my','Selangor');
